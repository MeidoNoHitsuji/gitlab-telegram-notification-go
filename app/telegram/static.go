...
func UpdateMessageWithParse(message *tgbotapi.Message, text string, keyboard interface{}) (*tgbotapi.Message, error) {
	bot := Instant()
	...
	editConf.ParseMode = tgbotapi.ModeHTML
...
func UpdateMessageWithParseById(message *tgbotapi.Message, text string, keyboard interface{}) (*tgbotapi.Message, error) {
	db := database.Instant()
	...
	return UpdateMessageWithParse(message, text, keyboard)
}
